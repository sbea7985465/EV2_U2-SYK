...
namespace SYK.Controllers
{
    public class ServiciosController : Controller
    {
        ...
        public ServiciosController(SykContext context)
        {
            _context = context;
        }
        ...
        {
            var sykContext = _context.Servicios.Include(s => s.Usuario);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Precio,Sku,Estado,UsuarioId")] Servicio servicio)
        {
            if (id != servicio.Id)
            {
                return NotFound();
